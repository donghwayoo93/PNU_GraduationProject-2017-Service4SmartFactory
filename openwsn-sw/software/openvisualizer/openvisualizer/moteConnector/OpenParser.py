...
class OpenParser(Parser.Parser):
    ...
    SERFRAME_PC2MOTE_RESPONSE          = ord('A')
    ...
    def __init__(self):
        ...
        self.parserManual    = ParserManual.ParserManual()
        ...
        self._addSubParser(
            index  = 0,
            val    = self.SERFRAME_MOTE2PC_MANUAL,
            parser = self.parserManual.parseInput,
        )
    #======================== public ==========================================
